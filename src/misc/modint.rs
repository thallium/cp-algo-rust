...
//!
//! ```ignore
//! use rust_cp::misc::modint::ModInt1000000007 as Mint; // rename to whatever you want
...
//!
//! ```ignore
//! use rust_cp::misc::modint::ModInt as Mint; // rename to whatever you want
//! use proconio::{input, source::once::OnceSource};
//!
//! input! {
...
///
/// ```ignore
/// use rust_cp::misc::modint::ModInt1000000007 as Mint;
/// use proconio::{input, source::once::OnceSource};
///
/// input! {
///     from OnceSource::from("1000000006 2\n"),
...
///             enum $name {}
///
///             impl rust_cp::misc::modint::Modulus for $name {
///                 const VALUE: u32 = $value;
///                 const HINT_VALUE_IS_PRIME: bool = $is_prime;
///
///                 fn butterfly_cache() -> &'static ::std::thread::LocalKey<::std::cell::RefCell<::std::option::Option<rust_cp::misc::modint::ButterflyCache<Self>>>> {
///                     thread_local! {
///                         static BUTTERFLY_CACHE: ::std::cell::RefCell<::std::option::Option<rust_cp::misc::modint::ButterflyCache<$name>>> = ::std::default::Default::default();
///                     }
///                     &BUTTERFLY_CACHE
///                 }
///             }
...
/// }
///
/// use rust_cp::misc::modint::StaticModInt;
///
...
///
/// ```ignore
/// use rust_cp::misc::modint::ModInt as Mint;
/// use proconio::{input, source::once::OnceSource};
///
/// input! {
///     from OnceSource::from("3 3 7\n"),
    ...
    + DivAssign
{
    ...
    ///
    /// ```
    /// use rust_cp::misc::modint::ModIntBase;
    ///
    /// fn f<Z: ModIntBase>() {
    ///     let _: u32 = Z::modulus();
    /// }
...
#[cfg(test)]
mod tests {
    use crate::misc::modint::ModInt1000000007;
